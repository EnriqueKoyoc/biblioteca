                        ...
                        <tr>
                            ...
                            <td>
                                <form action="">
                                    ...
                                    <p class="text-center">
                                        <button class="btn btn-raised btn-danger btn-xs"><i
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <div class="form-group label-floating">
                                    ...
                                    <input pattern="[a-zA-Z0-9-]{1,30}" class="form-control" type="text"
                                        name="codigo-up" required="" maxlength="30">
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-6">
                                <div class="form-group label-floating">
                                    <label class="control-label">Título *</label>
                                    <input pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ ]{1,30}" class="form-control" type="text"
                                        name="titulo-up" required="" maxlength="30">
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-6">
                                <div class="form-group label-floating">
                                    ...
                                    <input pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ ]{1,30}" class="form-control" type="text"
                                        name="autor-up" required="" maxlength="30">
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-6">
                                <div class="form-group label-floating">
                                    ...
                                    <input pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,30}" class="form-control" type="text"
                                        name="pais-up" maxlength="30">
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-6">
                                <div class="form-group label-floating">
                                    <label class="control-label">Año</label>
                                    <input pattern="[0-9]{1,4}" class="form-control" type="text" name="year-up"
                                        maxlength="4">
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-6">
                                <div class="form-group label-floating">
                                    ...
                                    <input pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,30}" class="form-control" type="text"
                                        name="editorial-up" maxlength="30">
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-6">
                                <div class="form-group label-floating">
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-6">
                                <div class="form-group label-floating">
                                    ...
                                    <input pattern="[0-9.]{1,7}" class="form-control" type="text" name="precio-up"
                                        maxlength="7">
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-6">
                                <div class="form-group label-floating">
                                    ...
                                    <input pattern="[0-9]{1,3}" class="form-control" type="text" name="ejemplares-up"
                                        maxlength="3">
                                </div>
                            </div>
                            <div class="col-xs-12">
                                <div class="form-group label-floating">
                                    ...
                                    <input pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ ]{1,30}" class="form-control" type="text"
                                        name="ubicacion-up" maxlength="30">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <fieldset>
                    ...
                    <div class="col-xs-12">
                        <div class="form-group">
                            ...
                            <span><small>Tamaño máximo de los archivos adjuntos 5MB. Tipos de archivos permitidos
                                    imágenes: PNG, JPEG y JPG</small></span>
                        </div>
                    </div>
                    <div class="col-xs-12">
                        <div class="form-group">
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="panel panel-danger">
                ...
                <div class="panel-body">
                    <p class="lead">
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nisi voluptatem quas impedit, sint eos
                        corrupti cupiditate.
                    </p>
                    <form>
