...
<div class="container-fluid">
    ...
    <ul class="breadcrumb breadcrumb-tabs">
        ...
        <li>
            <a href="<?php echo SERVERURL; ?>provider-list/" class="btn btn-success">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <div class="form-group label-floating">
                                    ...
                                    <input pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,50}" class="form-control" type="text"
                                        name="responsable-reg" required="" maxlength="50">
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-6">
                                <div class="form-group label-floating">
                                    <label class="control-label">Teléfono</label>
                                    <input pattern="[0-9+]{1,15}" class="form-control" type="text" name="telefono-reg"
                                        maxlength="15">
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-6">
